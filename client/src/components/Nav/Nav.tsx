          ...
          <div className="h-full w-[320px] md:w-[260px]">
            <div className="flex h-full min-h-0 flex-col">
              ...
              >
                ...
                >
                  <nav className="flex h-full w-full flex-col px-3 pb-0 pb-3.5">
                    <div className="flex flex h-14 items-center justify-between">
                      <button
                        className="focus-visible:bg-token-sidebar-surface-secondary h-10 rounded-lg px-2.5 text-[#7D7D7D] hover:bg-gray-100 focus-visible:outline-0 dark:text-[#b4b4b4] dark:hover:bg-gray-800"
